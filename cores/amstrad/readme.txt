...
Documentation about this deployment (contain also the list of known running games) : https://code.google.com/p/mist-board/wiki/CoreDocAmstrad
ROMs and a sample dsk is in OS6128_BASIC1-1_AMSDOS_MAXAM directory.
